...
const activeClass = ref('bg-rose-500 bg-opacity-25 text-white border-white py-4')
const inactiveClass = ref('border-gray-900 text-gray-500 hover:bg-gray-600 hover:bg-opacity-25 hover:text-gray-700')

const routes = ref([
  { name: 'Cursos', path: '/client/client-dashboard', icon: '/icons/3.svg' },
  { name: 'Perguntas', path: '/client/questions', icon: '/icons/2.svg' },
])
</script>
<template>
